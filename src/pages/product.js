...
import productCal from '../images/product-cal.svg';
import productAlert from '../images/product-alert.svg';
import productAudio from '../images/product-audio.svg';
                ...
                <TabContainer>
                    <Tab label="FOR AGENTS">
                        <section className="story">
                            ...
                            <Carousel>
                                <CarouselItem>
                                    <img className="story-img" src={productGraphic1} alt={'Real estate agent getting out of her car in front of a showing, using Arc\'s safety app'} />
                                </CarouselItem>
                                <CarouselItem>
                                    <img className="story-img" src={productScreenshot1} alt={'Screenshot of UI to set a new safety timer and screenshot of active timer'} />
                                </CarouselItem>
                            </Carousel>
                            ...
                            <Carousel>
                                <CarouselItem>
                                    <img className="story-img" src={productGraphic2} alt={'Real estate agent talking with client while phone buzzes'} />
                                </CarouselItem>
                                <CarouselItem>
                                    ...
                                    <img className="story-img" src={productScreenshot2} alt={'Screenshot of UI showing depleted timer and prompt to enter safety code to cancel timer'} />
                                </CarouselItem>
                            </Carousel>
                            ...
                            <p>If you ever feel unsafe, simply let the check-in timer run out or tap the Early Alert button to  instantly notify everyone in your safety network that you may be in danger.</p>
                                <Carousel>
                                    <CarouselItem>
                                        <img className="story-img" src={productGraphic3} alt={'Real estate agent attacked by client'} />
                                    </CarouselItem>
                                    <CarouselItem>
                                        <img className="story-img" src={productScreenshot3} alt={'Screenshot of UI showing danger notification'} />
                                    </CarouselItem>
                                </Carousel>
                        ...
                        <section className="highlight">
                            <img className="highlight-img" src={productCal} alt={'Calendar graphic'} />
                            ...
                            <img className="highlight-img" src={productAlert} alt={'Danger icon surrounded by Arc logos'} />
                            ...
                            <img className="highlight-img" src={productAudio} alt={'Microphone icon'} />
                    ...
                    <Tab label="FOR MANAGERS">
                        ...
                        <div className="center">
                            <img className="product-img" src={construction} />
                        </div>
