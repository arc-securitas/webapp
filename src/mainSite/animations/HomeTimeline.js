      ...
      <g id="ArcTimeline">
        ...
        <g id="check1" className={here.isVisible ? animations.checkOne : ""}>
          ...
          <g id="Interface / Check">
            <path id="Vector" d="M61.9183 58.5L67.6329 64.2788L79.0621 52.7212" stroke="white" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"/>
          </g>
        </g>
        <g id="check2" className={here.isVisible ? animations.checkTwo : ""}>
          ...
          <g id="Interface / Check_2">
            <path id="Vector_2" d="M195.626 58.6667L201.312 64.4698L212.683 52.8635" stroke="white" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"/>
          </g>
        </g>
        ...
        <g id="playhead" className={here.isVisible ? animations.scrub : ""}>
          <path id="Line 7" d="M4 4L4 99" stroke="black" strokeWidth="2"/>
          <circle id="Ellipse 38" cx="4" cy="4" r="3.5" fill="black" stroke="black"/>
        </g>
        <rect id="barFull" x="4" y="18.6667" width="400" height="80" rx="2.66667" stroke="black" strokeWidth="2"/>
      </g>
    </svg>
  );
}
