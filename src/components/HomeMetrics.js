  ...
  return (
    <svg viewBox="0 0 494 142" fill="none" xmlns="http://www.w3.org/2000/svg" ref={here.ref}>
      <g id="Metrics">
        ...
        <rect id="Rectangle 51" x="321.142" y="18.4263" width="10.9117" height="10.9117" transform="rotate(45 321.142 18.4263)" fill="#FFC582" stroke="black" stroke-width="2"/>
        <rect id="Rectangle 53" width="9.7953" height="9.7953" transform="matrix(0.707106 0.707108 -0.707106 0.707108 53.9263 15)" fill="#FFC582" stroke="black" stroke-width="2"/>
        <rect id="Rectangle 52" width="14.5441" height="14.5441" transform="matrix(0.707106 0.707108 -0.707106 0.707108 17.2842 104)" fill="#FFC582" stroke="black" stroke-width="2"/>
        <rect id="Rectangle 50" width="14.5441" height="14.5441" transform="matrix(0.707106 0.707108 -0.707106 0.707108 177.284 90)" fill="#FFC582" stroke="black" stroke-width="2"/>
        <rect id="Rectangle 49" width="20" height="20" transform="matrix(0.707108 0.707106 -0.707108 0.707106 478.142 107)" fill="#FFC582" stroke="black" stroke-width="2"/>
        <g>
          <mask id="WipeMask">
